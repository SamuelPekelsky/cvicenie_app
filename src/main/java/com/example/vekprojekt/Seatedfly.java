...
public class Seatedfly extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seatedfly);
    ...
    public void prechodnadruhycvik(View view ) {
        Intent davac = new Intent(getApplicationContext(), Chestpress.class);
        startActivity(davac);
    }
}