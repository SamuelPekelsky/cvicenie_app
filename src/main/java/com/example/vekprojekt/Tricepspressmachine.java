...
public class Tricepspressmachine extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tricepspressmachine);
    ...
    public void prechodnadruhycvik(View view ) {
        Intent davac = new Intent(getApplicationContext(), Dips.class);
        startActivity(davac);
    }
}