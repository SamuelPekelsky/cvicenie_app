...
public class Revreselateralpulldown extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_revreselateralpulldown);
    ...
    public void prechodnadruhycvik(View view ) {
        Intent davac = new Intent(getApplicationContext(), Singlearmrow.class);
        startActivity(davac);
    }
}