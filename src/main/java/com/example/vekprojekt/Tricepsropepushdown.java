...
public class Tricepsropepushdown extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tricepsropepushdown);
    ...
    public void prechodnadruhycvik(View view ) {
        Intent davac = new Intent(getApplicationContext(), Tricepspressmachine.class);
        startActivity(davac);
    }
}