...
public class alternatedumbellcurl extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_alternatedumbellcurl);
    ...
    public void prechodnadruhycvik(View view ) {
        Intent davac = new Intent(getApplicationContext(), preachercurl.class);
        startActivity(davac);
    }
}