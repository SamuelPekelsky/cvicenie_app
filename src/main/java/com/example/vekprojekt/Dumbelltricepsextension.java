...
public class Dumbelltricepsextension extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dumbelltricepsextension);
    ...
    public void prechodnadruhycvik(View view ) {
        Intent davac = new Intent(getApplicationContext(), Tricepsropepushdown.class);
        startActivity(davac);
    }
}